...
const CANONICAL_INGREDIENTS = [
  ...
  { canonicalName: 'Doodhi (Bottle Gourd)', category: 'Vegetable', aliases: ['doodhi (bottle gourd)'], unitConversions: { g: 1 } },
  ...
  { canonicalName: 'Coriander Leaves', category: 'Herb',
    aliases: ['coriander leaves', 'coriander', 'cilantro'], unitConversions: { g: 1, tbsp: 4, cup: 16 } },
  ...
  { canonicalName: 'Cumin Seeds', category: 'Spice',
    aliases: ['cumin seeds', 'jeera (cumin seeds)', 'jeera (cumin)'], unitConversions: { g: 1, tsp: 2 } },
  ...
  { canonicalName: 'Date', category: 'Fruit', aliases: ['date'], unitConversions: { piece: 8 } },
  ...
  // ── Grains / Flours / Bread ─────────────────────────────────────────
  { canonicalName: 'Rice', category: 'Grain', aliases: ['rice', 'white rice'], unitConversions: { g: 1 } },
  ...
  { canonicalName: 'Bajra (Pearl Millet) Flour', category: 'Grain', aliases: ['bajra (pearl millet) flour'], unitConversions: { g: 1 } },
  ...
  { canonicalName: 'Red Kidney Beans', category: 'Legume', aliases: ['red kidney beans'], unitConversions: { g: 1, cup: 177 } },
  ...
  { canonicalName: 'Makhana', category: 'Nut/Seed', aliases: ['makhana'], unitConversions: { g: 1, cup: 14 } },
