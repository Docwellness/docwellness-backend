 ...
 * catalog - prod-safe copy of audit-recipe-translations.js, using the
 * app's own connectDB() (handles prod's self-hosted Mongo TLS CA) instead
 * of a bare mongoose.connect(). Meant to run directly in the production
 * environment (e.g. a Coolify terminal).
 *
 * Usage:  node scripts/audit-recipe-translations-prod.js [--json]
