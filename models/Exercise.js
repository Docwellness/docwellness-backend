...
const exerciseSchema = new mongoose.Schema(
  {
    ...
    // AI-estimated average seconds a normal adult takes to complete one
    // repetition, generated by generateExerciseWithAI alongside met. Used
    // as a last-resort fallback (see utils/exerciseHelpers.js's
    // estimateDurationMinutes) to approximate a session's duration from
    // sets/reps when neither the dietician's plan nor the patient supplies
    // an explicit duration at log time.
    secondsPerRep: {
      type: Number,
      default: null,
      min: 1,
